...
print('The initial state of the puzzle is:', file=open("nodePath_2.txt", "w"))
for a in start_config:
    print(*a, file=open("nodePath_2.txt", "a"))
...
print('Location of the blank tile is:', location, file=open("nodePath_2.txt", "a"))
print(' ', file=open("nodePath_2.txt", "a"))
...
temp_goal = goal_node
print("The Solution sequence would be-", file=open("nodePath_2.txt", "a"))
while compare(temp_goal.config, start_config) == False:
    print(temp_goal.config,  file=open("nodePath_2.txt", "a"))
    temp_goal = temp_goal.parent
print(start_config,  file=open("nodePath_2.txt", "a"))


print("Total number of nodes possible: ", len(final_node),  file=open("nodePath_2.txt", "a"))
end_time = datetime.now()
time_taken = end_time - start_time
print("Time taken: ", time_taken,  file=open("nodePath_2.txt", "a")) 